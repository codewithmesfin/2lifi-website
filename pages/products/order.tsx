                    ...
                    <div className="md:flex md:items-center md:justify-between md:space-x-10">
                        <div className='w-full md:w-1/2'>
                            ...
                            <h1 className="text-gray-200 text-white text-3xl md:text-5xl pt-2">
                                Streamlining Order Management with 2lifi
                            </h1>
                        ...
                        <div className='w-full md:w-1/2 py-10 md:py-1'>
                            <img
                                src="https://img.freepik.com/free-vector/dashboard-user-panel_23-2148390498.jpg?size=626&ext=jpg&uid=R19609540&ga=GA1.1.617832925.1708503188&semt=ais"
